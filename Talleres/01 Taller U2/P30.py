# Las importaciones de cualquier índole se deben realizar al inicio del código.
# Es para mantener orden en el código fuente.
...
n1 = randint(1, 50)
n2 = randint(2, 5)
print("Primer número: {}".format(n1))
print("Segundo número: {}".format(n2))
print("Producto: {}".format(n1 * n2))